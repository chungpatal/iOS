...
class PlaceListCollectionViewCell: UICollectionViewCell, NibLoadable {
    @IBOutlet private weak var backView: UIView!
    @IBOutlet private weak var categoryLabel: UILabel!
    override func awakeFromNib() {
        self.backView.backgroundColor = #colorLiteral(red: 0.9725490196, green: 0.9725490196, blue: 0.9725490196, alpha: 1)
